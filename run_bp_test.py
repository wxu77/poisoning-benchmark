...
import poison_crafting.craft_poisons_bp
...
def main(args):
    # Determine paths
    poisons_path = os.path.join(args.output_path, "bp_poisons", args.model, args.dataset, args.pretrain_dataset, str(args.target_id), str(args.poison_class))
    output_path = os.path.join(args.output_path, "bp_logs", args.dist_rank)
    ...
    poison_crafting.craft_poisons_bp.main2(bp_args)
